...
class AdicionarPartido extends StatefulWidget {
  AdicionarPartido({Key key}) : super(key: key);

  @override
  _AdicionarPartidoState createState() => _AdicionarPartidoState();
}

class _AdicionarPartidoState extends State<AdicionarPartido> {
...
class IdPartido extends StatelessWidget {
  //late int i;
  @override
  Widget build(BuildContext context) {
    var _controller;
...
class ApodoPartido extends StatelessWidget {
  //late int i;
  @override
  Widget build(BuildContext context) {
    var _controller;
...
class BotonAdicionarPartido extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
