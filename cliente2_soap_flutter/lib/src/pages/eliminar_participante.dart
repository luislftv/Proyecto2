...
class EliminarParticipante extends StatefulWidget {
  EliminarParticipante({Key key}) : super(key: key);

  @override
  _EliminarParticipanteState createState() => _EliminarParticipanteState();
}

class _EliminarParticipanteState extends State<EliminarParticipante> {
...
class BotonEliminarParticipante extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(
      constraints: BoxConstraints(minWidth: 180, minHeight: 60.0),
