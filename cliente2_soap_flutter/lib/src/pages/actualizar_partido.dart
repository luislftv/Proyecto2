...
class ActualizarPartido extends StatefulWidget {
  ActualizarPartido({Key key}) : super(key: key);

  @override
  _ActualizarPartidoState createState() => _ActualizarPartidoState();
}

class _ActualizarPartidoState extends State<ActualizarPartido> {
