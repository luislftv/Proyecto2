...
class EliminarPartido extends StatefulWidget {
  EliminarPartido({Key key}) : super(key: key);

  @override
  _EliminarPartidoState createState() => _EliminarPartidoState();
}

class _EliminarPartidoState extends State<EliminarPartido> {
